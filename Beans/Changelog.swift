...
enum ChangelogStore {
    ...
    static let logs: [VersionLog] = [
        VersionLog(
            ...
            title: "主页与播放器体验优化",
            features: [
                "主页顶部支持网易云音乐、QQ音乐、酷狗音乐的自定义前后顺序，并同步到搜索、音乐库和账号页面",
                "主页问候文字支持多行输入，文字大小和标题区高度上限提升，并可隐藏主页用户名",
                "播放器按钮样式精简为经典圆形和线框图标，移除极简无比、柔和底板",
                "播放器设置重新整理分组与间距，保留播放、歌词、效果、布局和封面全部功能",
                "优化设置页高刷空转，减少进入设置页后的额外发热"
            ],
            fixes: [
                "修复隐藏排序按钮只对主页生效的问题，现在主页、音乐库和我的页面同步隐藏",
                "修复 QQ 音乐主页热门歌单封面不显示的问题，并统一网易云音乐页面名称"
            ]
        ),
        VersionLog(
            id: "1.5.6",
