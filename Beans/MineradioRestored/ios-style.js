(function(){
  ...
  style.textContent = `
    ...
    html.ios-shell-root #login-modal,
    html.ios-shell-root #user-modal,
    html.ios-shell-root #login-guide-canvas,
    html.ios-shell-root #trial-login-btn,
    html.ios-shell-root #login-provider-netease,
    html.ios-shell-root #login-provider-qq,
    html.ios-shell-root #login-provider-kugou,
    html.ios-shell-root #login-both-btn,
    html.ios-shell-root #qq-cookie-toggle-btn,
    html.ios-shell-root #qq-cookie-panel,
    html.ios-shell-root #refresh-qr-btn,
    html.ios-shell-root #account-add-netease,
    html.ios-shell-root #account-add-qq,
    html.ios-shell-root #account-add-kugou,
